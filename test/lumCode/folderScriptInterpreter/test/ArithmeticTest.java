...
public class ArithmeticTest {
	...
	/*
	 * 
	 * @Test void multiplicationTest() throws InterpreterException { // File
	 ...
	 * 
	 * f1.action(); assertTrue(((FileVariable)
	 * f1.result()).getVar().getAbsolutePath().equals("C:\\temp\\docs\\dok4.txt"));
	 * 
	 * boolean fr1 = false; try { f1.action(); fr1 = true; } catch
	 * (InterpreterException e) { // Do nothing } assertFalse(fr1);
	 * 
	 * boolean fr2 = false; try { f2.action(); fr2 = true; } catch
	 * (InterpreterException e) { // Do nothing } assertFalse(fr2);
	 * 
	 * boolean fr3 = false; try { f3.action(); fr3 = true; } catch
	 * (InterpreterException e) { // Do nothing } assertFalse(fr3);
	 * 
	 * boolean fr4 = false; try { f4.action(); fr4 = true; } catch
	 * (InterpreterException e) { // Do nothing } assertFalse(fr4);
	 * 
	 * boolean fr5 = false; try { f5.action(); fr5 = true; } catch
	 * (InterpreterException e) { // Do nothing } assertFalse(fr5);
	 * 
	 * boolean fr6 = false; try { f6.action(); fr6 = true; } catch
	 * (InterpreterException e) { // Do nothing } assertFalse(fr6);
	 * 
	 * // Folder Arithmetic d1 = new Arithmetic(fol, ArithmeticType.SUBTRACTION,
	 * fil); Arithmetic d2 = new Arithmetic(fol, ArithmeticType.SUBTRACTION, fol);
	 * Arithmetic d3 = new Arithmetic(fol, ArithmeticType.SUBTRACTION, txt);
	 * Arithmetic d4 = new Arithmetic(fol, ArithmeticType.SUBTRACTION, num);
	 * Arithmetic d5 = new Arithmetic(fol, ArithmeticType.SUBTRACTION, arr);
	 * Arithmetic d6 = new Arithmetic(fol, ArithmeticType.SUBTRACTION, spe);
	 * 
	 * d1.action(); assertTrue(((FileVariable)
	 * d1.result()).getVar().getAbsolutePath().equals("C:\\temp\\docs\\dok4.txt"));
	 * 
	 * boolean dr1 = false; try { d1.action(); dr1 = true; } catch
	 * (InterpreterException e) { // Do nothing } assertFalse(dr1);
	 * 
	 * boolean dr2 = false; try { d2.action(); dr2 = true; } catch
	 * (InterpreterException e) { // Do nothing } assertFalse(dr2);
	 * 
	 * boolean dr3 = false; try { d3.action(); dr3 = true; } catch
	 * (InterpreterException e) { // Do nothing } assertFalse(dr3);
	 * 
	 * boolean dr4 = false; try { d4.action(); dr4 = true; } catch
	 * (InterpreterException e) { // Do nothing } assertFalse(dr4);
	 * 
	 * boolean dr5 = false; try { d5.action(); dr5 = true; } catch
	 * (InterpreterException e) { // Do nothing } assertFalse(dr5);
	 * 
	 * boolean dr6 = false; try { d6.action(); dr6 = true; } catch
	 * (InterpreterException e) { // Do nothing } assertFalse(dr6);
	 * 
	 * // Text Arithmetic t1 = new Arithmetic(txt, ArithmeticType.SUBTRACTION, fil);
	 * Arithmetic t2 = new Arithmetic(txt, ArithmeticType.SUBTRACTION, fol);
	 * Arithmetic t3 = new Arithmetic(txt, ArithmeticType.SUBTRACTION, txt);
	 * Arithmetic t4 = new Arithmetic(txt, ArithmeticType.SUBTRACTION, num);
	 * Arithmetic t5 = new Arithmetic(txt, ArithmeticType.SUBTRACTION, arr);
	 * Arithmetic t6 = new Arithmetic(txt, ArithmeticType.SUBTRACTION, spe);
	 * 
	 * t1.action(); assertTrue(((FileVariable)
	 * t1.result()).getVar().getAbsolutePath().equals("C:\\temp\\docs\\dok4.txt"));
	 * 
	 * boolean tr1 = false; try { t1.action(); tr1 = true; } catch
	 * (InterpreterException e) { // Do nothing } assertFalse(tr1);
	 * 
	 * boolean tr2 = false; try { t2.action(); tr2 = true; } catch
	 * (InterpreterException e) { // Do nothing } assertFalse(tr2);
	 * 
	 * boolean tr3 = false; try { t3.action(); tr3 = true; } catch
	 * (InterpreterException e) { // Do nothing } assertFalse(tr3);
	 * 
	 * boolean tr4 = false; try { t4.action(); tr4 = true; } catch
	 * (InterpreterException e) { // Do nothing } assertFalse(tr4);
	 * 
	 * boolean tr5 = false; try { t5.action(); tr5 = true; } catch
	 * (InterpreterException e) { // Do nothing } assertFalse(tr5);
	 * 
	 * boolean tr6 = false; try { t6.action(); tr6 = true; } catch
	 * (InterpreterException e) { // Do nothing } assertFalse(tr6);
	 * 
	 * // Number Arithmetic n1 = new Arithmetic(num, ArithmeticType.SUBTRACTION,
	 * fil); Arithmetic n2 = new Arithmetic(num, ArithmeticType.SUBTRACTION, fol);
	 * Arithmetic n3 = new Arithmetic(num, ArithmeticType.SUBTRACTION, txt);
	 * Arithmetic n4 = new Arithmetic(num, ArithmeticType.SUBTRACTION, num);
	 * Arithmetic n5 = new Arithmetic(num, ArithmeticType.SUBTRACTION, arr);
	 * Arithmetic n6 = new Arithmetic(num, ArithmeticType.SUBTRACTION, spe);
	 * 
	 * n1.action(); assertTrue(((FileVariable)
	 * n1.result()).getVar().getAbsolutePath().equals("C:\\temp\\docs\\dok4.txt"));
	 * 
	 * boolean nr1 = false; try { n1.action(); nr1 = true; } catch
	 * (InterpreterException e) { // Do nothing } assertFalse(nr1);
	 * 
	 * boolean nr2 = false; try { n2.action(); nr2 = true; } catch
	 * (InterpreterException e) { // Do nothing } assertFalse(nr2);
	 * 
	 * boolean nr3 = false; try { n3.action(); nr3 = true; } catch
	 * (InterpreterException e) { // Do nothing } assertFalse(nr3);
	 * 
	 * boolean nr4 = false; try { n4.action(); nr4 = true; } catch
	 * (InterpreterException e) { // Do nothing } assertFalse(nr4);
	 * 
	 * boolean nr5 = false; try { n5.action(); nr5 = true; } catch
	 * (InterpreterException e) { // Do nothing } assertFalse(nr5);
	 * 
	 * boolean nr6 = false; try { n6.action(); nr6 = true; } catch
	 * (InterpreterException e) { // Do nothing } assertFalse(nr6);
	 * 
	 * // Array Arithmetic a1 = new Arithmetic(arr, ArithmeticType.SUBTRACTION,
	 * fil); Arithmetic a2 = new Arithmetic(arr, ArithmeticType.SUBTRACTION, fol);
	 * Arithmetic a3 = new Arithmetic(arr, ArithmeticType.SUBTRACTION, txt);
	 * Arithmetic a4 = new Arithmetic(arr, ArithmeticType.SUBTRACTION, num);
	 * Arithmetic a5 = new Arithmetic(arr, ArithmeticType.SUBTRACTION, arr2);
	 * Arithmetic a6 = new Arithmetic(arr, ArithmeticType.SUBTRACTION, spe);
	 * 
	 * a1.action(); assertTrue(((FileVariable)
	 * a1.result()).getVar().getAbsolutePath().equals("C:\\temp\\docs\\dok4.txt"));
	 * 
	 * boolean ar1 = false; try { a1.action(); ar1 = true; } catch
	 * (InterpreterException e) { // Do nothing } assertFalse(ar1);
	 * 
	 * boolean ar2 = false; try { a2.action(); ar2 = true; } catch
	 * (InterpreterException e) { // Do nothing } assertFalse(ar2);
	 * 
	 * boolean ar3 = false; try { a3.action(); ar3 = true; } catch
	 * (InterpreterException e) { // Do nothing } assertFalse(ar3);
	 * 
	 * boolean ar4 = false; try { a4.action(); ar4 = true; } catch
	 * (InterpreterException e) { // Do nothing } assertFalse(ar4);
	 * 
	 * boolean ar5 = false; try { a5.action(); ar5 = true; } catch
	 * (InterpreterException e) { // Do nothing } assertFalse(ar5);
	 * 
	 * boolean ar6 = false; try { a6.action(); ar6 = true; } catch
	 * (InterpreterException e) { // Do nothing } assertFalse(ar6);
	 * 
	 * // Array Arithmetic s1 = new Arithmetic(spe, ArithmeticType.SUBTRACTION,
	 * fil); Arithmetic s2 = new Arithmetic(spe, ArithmeticType.SUBTRACTION, fol);
	 * Arithmetic s3 = new Arithmetic(spe, ArithmeticType.SUBTRACTION, txt);
	 * Arithmetic s4 = new Arithmetic(spe, ArithmeticType.SUBTRACTION, num);
	 * Arithmetic s5 = new Arithmetic(spe, ArithmeticType.SUBTRACTION, arr);
	 * Arithmetic s6 = new Arithmetic(spe, ArithmeticType.SUBTRACTION, spe);
	 * 
	 * s1.action(); assertTrue(((FileVariable)
	 * s1.result()).getVar().getAbsolutePath().equals("C:\\temp\\docs\\dok4.txt"));
	 * 
	 * boolean sr1 = false; try { s1.action(); sr1 = true; } catch
	 * (InterpreterException e) { // Do nothing } assertFalse(sr1);
	 * 
	 * boolean sr2 = false; try { s2.action(); sr2 = true; } catch
	 * (InterpreterException e) { // Do nothing } assertFalse(sr2);
	 * 
	 * boolean sr3 = false; try { s3.action(); sr3 = true; } catch
	 * (InterpreterException e) { // Do nothing } assertFalse(sr3);
	 * 
	 * boolean sr4 = false; try { s4.action(); sr4 = true; } catch
	 * (InterpreterException e) { // Do nothing } assertFalse(sr4);
	 * 
	 * boolean sr5 = false; try { s5.action(); sr5 = true; } catch
	 * (InterpreterException e) { // Do nothing } assertFalse(sr5);
	 * 
	 * boolean sr6 = false; try { s6.action(); sr6 = true; } catch
	 * (InterpreterException e) { // Do nothing } assertFalse(sr6); }
	 * 
	 * 
	 * @Test void divisionTest() throws InterpreterException { // File Arithmetic f1
	 * = new Arithmetic(fil, ArithmeticType.DIVISION, fil2); Arithmetic f2 = new
	 * Arithmetic(fil, ArithmeticType.DIVISION, fol); Arithmetic f3 = new
	 * Arithmetic(fil, ArithmeticType.DIVISION, txt); Arithmetic f4 = new
	 * Arithmetic(fil, ArithmeticType.DIVISION, num); Arithmetic f5 = new
	 * Arithmetic(fil, ArithmeticType.DIVISION, arr); Arithmetic f6 = new
	 * Arithmetic(fil, ArithmeticType.DIVISION, spe);
	 * 
	 * f1.action(); assertTrue(((FileVariable)
	 * f1.result()).getVar().getAbsolutePath().equals("C:\\temp\\docs\\dok4.txt"));
	 * 
	 ...
	 * 
	 * 
	 * @Test void moduloTest() throws InterpreterException { // File Arithmetic f1 =
	 * new Arithmetic(fil, ArithmeticType.MODULO, fil2); Arithmetic f2 = new
	 * Arithmetic(fil, ArithmeticType.MODULO, fol); Arithmetic f3 = new
	 * Arithmetic(fil, ArithmeticType.MODULO, txt); Arithmetic f4 = new
	 * Arithmetic(fil, ArithmeticType.MODULO, num); Arithmetic f5 = new
	 * Arithmetic(fil, ArithmeticType.MODULO, arr); Arithmetic f6 = new
	 * Arithmetic(fil, ArithmeticType.MODULO, spe);
	 * 
	 * f1.action(); assertTrue(((FileVariable)
	 * f1.result()).getVar().getAbsolutePath().equals("C:\\temp\\docs\\dok4.txt"));
	 * 
